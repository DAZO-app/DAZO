...
echo -e " 9)  [Dev Mode]     ./dazo-dev.sh            - Lancer l'environnement avec Vite HMR"
echo -e " 10) [Git Pull]     ./dazo-gitpull.sh        - Récupérer le code sans l'appliquer"

echo ""
echo -e " q)  Quitter"
echo ""
echo -en "${GREEN}Action souhaitée [1-10 / q] : ${NC}"
read choice
